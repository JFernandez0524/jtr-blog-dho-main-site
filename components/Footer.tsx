  ...
  return (
    <footer className="border-t border-remax-slate/10 mt-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                ...
                {siteConfig.social.zillow && (
                  ...
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.006 0C5.388 0 0 5.388 0 12.006c0 6.617 5.388 12.005 12.006 12.005 6.617 0 12.005-5.388 12.005-12.005C24.011 5.388 18.623 0 12.006 0zm5.368 14.655c-.187.39-.57.652-1.011.652H7.637c-.441 0-.824-.262-1.011-.652a1.16 1.16 0 0 1 .098-1.174l4.363-5.82a1.162 1.162 0 0 1 1.826 0l4.363 5.82c.262.35.311.813.098 1.174z"/>
                    </svg>
                  </a>
                )}
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-remax-slate/10">
